SecureHeaders::Configuration.default do |config|
  ...
  config.csp = {
    ...
    child_src: %w('self' *.facebook.com *.facebook.net *.twitter.com *.disqus.com disqus.com *.youtube.com), # if child-src isn't supported, the value for frame-src will be set.
