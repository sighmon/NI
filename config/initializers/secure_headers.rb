SecureHeaders::Configuration.default do |config|
  ...
  config.csp = {
    ...
    script_src: %W('self' 'unsafe-inline' 'unsafe-eval' *.google-analytics.com *.twitter.com *.twimg.com *.facebook.com *.facebook.net *.disqus.com *.thawte.com *.googletagmanager.com *.googleadservices.com *.newrelic.com bam.nr-data.net #{ENV['CLOUDFRONT_SERVER']}.cloudfront.net),
